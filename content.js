...
const CONTENT = {
  ...
  about: {
    ...
    headline: { en: '', zh: '' },
    tagline: {
      en: "Hi, I'm Helen! I'm a materials scientist specialising in analytical characterisation techniques, specifically, electron microscopy. Through my research, I have developed novel AI workflows to show how 'big-data' experiments can be harnessed into decision-ready outputs for biopharma R&D (at GSK) and materials synthesis (at Altrove). I now work in biopharma R&D strategy consulting at L.E.K. Consulting.",
