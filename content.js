    ...
    cards: [
      {
        ...
        body: {
          en: `
            <p class="card-text">I am an expert in analytical characterisation techniques for innovations that require working at the nanoscale. A first-class graduate (MEng) from Oxford, I spent my masters year researching the use of convolutional neural networks (CNN) for atomic-resolution image analysis; streamlining analysis of terabytes of electron micrographs into several minutes of CNN work. I then moved to Cambridge for a GSK-sponsored PhD: a switch to biopharma R&amp;D. Using cryo-electron microscopy, a technique capable of generating terabytes of data in a single afternoon, I predicted and validated the crystal structures of new drugs, with a highlight application in nano-engineering the slow-release properties of a long-acting injectable HIV drug (cabotegravir). I subsequently applied my crystallographic expertise to help build out a virtual lab in an AI x materials startup: where I designed and implemented automated experimental analysis pipelines. I have since moved to life sciences biopharma R&amp;D strategy at L.E.K. Consulting, connecting the deep science of drug discovery to the delivery of commercial outcomes.</p>
            <div class="pill-row">
